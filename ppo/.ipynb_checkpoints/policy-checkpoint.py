...
class PPO_MLP_strategy(nn.Module):
    def __init__(self, skip, act_dim, obs_dim,input_dim,layers,layers_critic,omniscent):
        ...
        self.net = MLP(in_size=input_dim, out_size=act_dim,mlp_size=mult*input_dim,num_layers=1+layers)    
        ...
        self.critic =  MLP(in_size=obs_dim, out_size=1,mlp_size=mult*obs_dim,num_layers=1+layers_critic) 
